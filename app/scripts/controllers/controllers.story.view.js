...
angular.module('immersiveAngularApp')
    .controller('StoryViewController', function($scope, $routeParams, $css, firebaseStoryService, $mdDialog) {
        ...
        function showDialog(template, type, id, $event) {
            ...
            $mdDialog.show({
                parent: parentEl,
                targetEvent: $event,
                templateUrl: 'views/templates.dialog.view.html',
                clickOutsideToClose: true,
                controller: 'storyViewDialogController'
            });
        }
