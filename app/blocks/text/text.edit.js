...
angular.module('immersiveAngularApp')
    .directive('editText', function(firebaseBlocksService) {
        return {
            template: '<div class="o-block__text"><p ng-model="data.parameters.text" medium-editor bind-options="mediumBindOptions"></p></div><edit-audioplayer ng-if="data.parameters.media" parameters="data.parameters"></edit-audioplayer>',
            restrict: 'E',
            scope: {
                id: '=',
                article: '=',
