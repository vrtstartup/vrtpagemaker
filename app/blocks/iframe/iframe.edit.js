...
angular.module('immersiveAngularApp')
    .directive('editIframe', function($sce) {
        return {
            template: '<div class="iframe google-maps"><iframe width="100%" height="auto" src="{{iframe}}" frameborder="0" webkit-playsinline allowfullscreen></iframe></div><edit-audioplayer ng-if="parameters.media" parameters="parameters"></edit-audioplayer></div>',
            restrict: 'E',
            scope: {
                parameters: '='
            },
